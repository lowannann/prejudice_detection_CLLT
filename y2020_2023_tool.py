...
def y2020to2023_search(query):
    y2020to2023_cons = yq.y2020to2023_filter(query)
    yq.data_cleaner(y2020to2023_cons)
    ...
    y2020to2023_search = RetrievalQA.from_chain_type(llm=llm, chain_type="stuff", retriever=vectorstore.as_retriever())

    return y2020to2023_search