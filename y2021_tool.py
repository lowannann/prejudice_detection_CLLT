...
def y2021_search(query):
    y2021_cons = yq.y2021_filter(query)
    yq.data_cleaner(y2021_cons)
    ...
    y2021_search = RetrievalQA.from_chain_type(llm=llm, chain_type="stuff", retriever=vectorstore.as_retriever())
