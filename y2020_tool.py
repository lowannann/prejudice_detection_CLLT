...
def y2020_search(query):
    y2020_cons = yq.y2020_filter(query)
    yq.data_cleaner(y2020_cons)
    ...
    y2020_search = RetrievalQA.from_chain_type(llm=llm, chain_type="stuff", retriever=vectorstore.as_retriever())
    return y2020_search
